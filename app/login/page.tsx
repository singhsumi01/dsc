    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6 relative overflow-hidden hero-gradient">
      ...
      <div className="w-full max-w-lg animate-fade-in-up relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-5xl font-black text-gray-900 tracking-tighter leading-none mb-2">Sign In</h1>
          <p className="text-gray-500 font-medium italic">Secure access to your Digital Signature vault.</p>
        </div>
